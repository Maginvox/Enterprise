...
FEXPORT FRenderPass* FRenderPassCreate(FRenderContext* pContext, const FRenderPassCreateInfo* pInfo);
FEXPORT void FRenderPassDestroy(FRenderContext* pContext, FRenderPass** ppRenderPass);
